...
switch ($accion) {
    ...
    // <editor-fold defaultstate="collapsed" desc="procesar pago en linea">
    case "procesar":
        $pago = new pago();
        $data = $_POST;
    ...
    // <editor-fold defaultstate="collapsed" desc="registrar, listar">
        case "registrar":
        case "listar":
        default :
        $propiedad = new propiedades();
...
// </editor-fold>
    ...
    // <editor-fold defaultstate="collapsed" desc="pago-tdc">
    case "pago-tdc":
        $propiedad = new propiedades();
        $facturas = new factura();
        $inmuebles = new inmueble();
...
// </editor-fold>
    ...
    // <editor-fold defaultstate="collapsed" desc="listaPagosPendientesOld">
    ...
    // <editor-fold defaultstate="collapsed" desc="ListarPagosPendientes">
    ...
    // <editor-fold defaultstate="collapsed" desc="reenviar email pago en linea">
    ...
    // <editor-fold defaultstate="collapsed" desc="reenviar email pago en linea(deprecate)">
